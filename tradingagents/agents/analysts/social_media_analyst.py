...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            "Use the get_twitter_sentiment(ticker, timeframe) tool to analyze Twitter and Stocktwits sentiment from curated financial accounts like Chart Champions, Unusual Whales, and Walter Bloomberg. "
